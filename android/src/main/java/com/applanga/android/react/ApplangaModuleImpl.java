...
public class ApplangaModuleImpl {
    public static final String NAME = "Applanga";
    private static final String TAG = "applanga";

    public static void setShowIdModeEnabled(boolean enabled, Promise promise) {
        try {
    ...
    public static void showDraftModeDialog(@Nullable Activity activity) {
    ...
    public static void setScreenShotMenuVisible(@Nullable Activity activity, final boolean visible) {
        if (activity == null) return;
        activity.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Applanga.setScreenShotMenuVisible(visible);
            }
        });
    }

    public static void setLanguage(String lang, Promise promise) {
        try {
    ...
    public static void setLanguageAndUpdate(String lang, final Promise promise) {
        try {
    ...
    public static void getString(String s, String d, Promise promise) {
        try {
    ...
    public static String getLocalizedValue(String key, String defaultValue) {
        return Applanga.getString(key, defaultValue);
    }

    public static void getStringWithArguments(String s, String d, ReadableMap a, Promise promise) {
        try {
    ...
    public static void update(ReadableArray languages, final Promise promise) {
    ...
    public static void localizedStringsForCurrentLanguage(Promise promise) {
        try {
    ...
    public static void localizeMap(ReadableMap map, Promise promise) {
        try {
    ...
    public static void localizeMapI18NextJsonV4(ReadableMap map, Promise promise) {
        try {
    ...
    private static Map<String, Object> convertReadableMapToMap(ReadableMap readableMap) {
