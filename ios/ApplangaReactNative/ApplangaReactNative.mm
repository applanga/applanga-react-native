...
RCT_EXPORT_METHOD(getString:(NSString *)key
    ...
    resolve([Applanga localizedStringForKey:key withDefaultValue:defaultValue]);
}

RCT_EXPORT_METHOD(getStringWithArguments:(NSString *)key
                  defaultValue:(NSString *)defaultValue
                  args:(NSDictionary *)args
                  resolve:(RCTPromiseResolveBlock)resolve
                  reject:(RCTPromiseRejectBlock)reject){
    resolve([Applanga localizedStringForKey:key withDefaultValue:defaultValue andArguments:args]);
}

- (NSString *)getLocalizedValue:(NSString *)key
                   defaultValue:(NSString *)defaultValue
{
    return [Applanga localizedStringForKey:key withDefaultValue:defaultValue];
}

RCT_EXPORT_METHOD(localizeMap:(NSDictionary *)map
                  resolve:(RCTPromiseResolveBlock)resolve
                  reject:(RCTPromiseRejectBlock)reject)
{
...
RCT_EXPORT_METHOD(localizeMapI18NextJsonV4:(NSDictionary *)map
                  resolve:(RCTPromiseResolveBlock)resolve
                  reject:(RCTPromiseRejectBlock)reject)
{
    ...
    while ((lang = [enumerator nextObject])) {
        NSDictionary *langMap = [map objectForKey:lang];
        if (!langMap) continue;
...
RCT_EXPORT_METHOD(localizedStringsForCurrentLanguage:(RCTPromiseResolveBlock)resolve
                  reject:(RCTPromiseRejectBlock)reject)
{
    resolve([Applanga localizedStringsForCurrentLanguage]);
}

RCT_EXPORT_METHOD(update:(NSArray *)languages
                  resolve:(RCTPromiseResolveBlock)resolve
                  reject:(RCTPromiseRejectBlock)reject)
{
...
RCT_EXPORT_METHOD(setLanguage:(NSString *)language
                  resolve:(RCTPromiseResolveBlock)resolve
                  reject:(RCTPromiseRejectBlock)reject){
    NSNumber *result = [NSNumber numberWithBool:([Applanga setLanguage:language])];
    resolve(result);
}

RCT_EXPORT_METHOD(setLanguageAndUpdate:(NSString *)language
                  resolve:(RCTPromiseResolveBlock)resolve
                  reject:(RCTPromiseRejectBlock)reject)
                 {
...
RCT_EXPORT_METHOD(setShowIdModeEnabled:(BOOL)enabled
                  resolve:(RCTPromiseResolveBlock)resolve
                  reject:(RCTPromiseRejectBlock)reject){
...
{
    return std::make_shared<facebook::react::NativeApplangaSpecJSI>(params);
}
#endif
