...
Pod::Spec.new do |s|
  ...
  s.source_files        = 'ApplangaReactNative/**/*.{h,m}'
  s.public_header_files = 'ApplangaReactNative/*.h'
  s.preserve_paths = 'ApplangaReactNative/**/*.{h,m}', 'README.md', 'LICENSE', 'package.json', '*.js'
